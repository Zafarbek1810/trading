  ...
  return (
    ...
    <div className="brokers-single">
      <ul id="breadcrumb">
        <span>
          <span>
            <a href="#">Главная</a>|<a href="#">Рейтинг броккеров</a>|
      ...
      <div className="brokers-single-review">
        ...
        <div className="brokers-single-review-item">
          ...
          <p>
            ...
            average daily transaction volume of more than 65 billion US dollars.
            Trusted by millions of users around the world, Binance features an
            unmatched portfolio of financial product offerings. This includes
            spot and margin trading, contract and options trading, staking
            services, support for fiat currency channels, and more.
          </p>
          <p>
